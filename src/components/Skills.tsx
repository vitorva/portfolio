  ...
  return (
    <div ref={skillsRef} style={{ scrollMarginTop: "10vh" }} className="skills">
      ...
      <div className="mySkills">
        ...
        <div className="skill">
          <h3>General knowledges</h3>I also acquired skills in many other
          technology-related fields. Specifically, I have focused on machine
          learning, mobile application development, cloud infrastructure and
          Devops. Furthermore, I have learned AGILE methods and to work
          collaboratively
        </div>
      </div>
    </div>
